...
justify-center p-4 gap-x-25 gap-y-8 mt-10"
      >
...
overflow-hidden lg:rounded-3xl bg-[#13162d]"
              ...
              <h1
                className="font-bold lg:text-2x1
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {iconLists.map((icon, i) => (
                    <div
                      key={icon}
                      className="border border-white/[0.2] rounded-full bg-black h-8 w-8 lg:w-10 lg:h-10 flex items-center justify-center"
                ...
                <div className="flex items-center justify-center ">
                  <p className="flex text-sm lg:text-lg md:text-xs text-purple-300">
                    check live site
                  </p>
