...
export const navItems = [
  ...
  { name: "Projects", link: "#projects", icon: <LuProjector /> },
  { name: "Testimonials", link: "#testimonials", icon: <SiCodeproject /> },
...
export const projects = [
  ...
  },
  {
    ...
    link: "https://github.com/Row-hit/iPhone-15-web-clone",
  },
];
...
export const workExperience = [
  ...
  {
    id: 2,
    title: "Mobile view Responsive",
    desc: "Designed and developed mobile view responsive  using tailwind.",
